...
notify_cmd_shot="${notify_cmd_base} -i applets-screenshooter"
notify_cmd_shot_win="${notify_cmd_base} -i applets-screenshooter"
...
countdown() {
	for sec in $(seq $1 -1 1); do
		notify-send -h string:x-canonical-private-synchronous:shot-notify -t 1000 -i "alarm-timer"  " Taking shot" " in: $sec secs"
		sleep 1
	done
}
